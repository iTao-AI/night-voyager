...
export const PRESENTATION_CODE_VALUES = {
  ...
  routeReason: ["complete_cost_and_fx_within_boundary", "synthetic_high_risk_alternative", "direct_program_fit_evidence_absent", "cost_or_fx_evidence_incomplete", "budget_refused", "japan_risk_or_program_fit_unresolved", "malaysia_program_fit_present", "budget_above_hard_ceiling", "budget_hard_ceiling_or_elasticity_exceeded"],
...
const CODE_COPY_KEYS = {
  ...
  routeReason: {
    ...
    cost_or_fx_evidence_incomplete: "reasonCostOrFxIncomplete",
    budget_refused: "reasonBudgetRefused",
    japan_risk_or_program_fit_unresolved: "reasonJapanRiskOrProgramFitUnresolved",
    malaysia_program_fit_present: "reasonMalaysiaProgramFitPresent",
