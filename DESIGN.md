...
- **Governed plan-execution route:** `/demo/plan?case_id=<case_id>` for the connected
  Case; bare `/demo/plan` (`happy` by default) or exact `blocked` query for
