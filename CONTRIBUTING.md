...
Night Voyager v0.1.4 is a local synthetic portfolio release with the prior portfolio workflow, the Night Voyager-owned governed DRA consumer contract, and versioned planning revision authority. Keep changes focused, public-neutral, and reproducible without remote credentials. Use Python 3.12.13, Node.js 24.18.0, a short-lived `codex/` branch, and test-first development for behavior.
