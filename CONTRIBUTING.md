...
- Migrations and RLS changes require integration/security tests using runtime-equivalent database roles; M0 contains neither migrations nor tenant tables.
