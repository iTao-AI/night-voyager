...
PLAN_EXECUTION_CASE_ID = UUID("4a000000-0000-0000-0000-000000000001")
PLAN_EXECUTION_RUN_ID = UUID("7a000000-0000-0000-0000-000000000001")
PLAN_EXECUTION_REVIEW_ID = UUID("9a000000-0000-0000-0000-000000000001")
PLAN_EXECUTION_BRIEF_ID = UUID("9b000000-0000-0000-0000-000000000001")
PLAN_EXECUTION_DECISION_ID = UUID("9c000000-0000-0000-0000-000000000001")
PLAN_EXECUTION_DECISION_RECEIPT_ID = UUID("9d000000-0000-0000-0000-000000000001")
PLAN_EXECUTION_TIMELINE_ID = UUID("9e000000-0000-0000-0000-000000000001")
PLAN_EXECUTION_HAPPY_ACTORS = (
    (
        "plan_execution_happy_advisor",
        "advisor",
        UUID("2a000000-0000-0000-0000-000000000001"),
        "Plan execution Happy advisor",
    ),
    (
        "plan_execution_happy_student",
        "student",
        UUID("2a000000-0000-0000-0000-000000000002"),
        "Plan execution Happy student",
    ),
    (
        "plan_execution_happy_parent",
        "parent",
        UUID("2a000000-0000-0000-0000-000000000003"),
        "Plan execution Happy parent",
    ),
)
BLOCKED_PLAN_EXECUTION_CASE_ID = UUID("4a000000-0000-0000-0000-000000000002")
BLOCKED_PLAN_EXECUTION_RUN_ID = UUID("7a000000-0000-0000-0000-000000000002")
BLOCKED_PLAN_EXECUTION_REVIEW_ID = UUID("9a000000-0000-0000-0000-000000000002")
BLOCKED_PLAN_EXECUTION_BRIEF_ID = UUID("9b000000-0000-0000-0000-000000000002")
BLOCKED_PLAN_EXECUTION_DECISION_ID = UUID("9c000000-0000-0000-0000-000000000002")
BLOCKED_PLAN_EXECUTION_DECISION_RECEIPT_ID = UUID("9d000000-0000-0000-0000-000000000002")
BLOCKED_PLAN_EXECUTION_TIMELINE_ID = UUID("9e000000-0000-0000-0000-000000000002")
PLAN_EXECUTION_BLOCKED_ACTORS = (
    (
        "plan_execution_blocked_advisor",
        "advisor",
        UUID("2b000000-0000-0000-0000-000000000001"),
        "Plan execution Blocked advisor",
    ),
    (
        "plan_execution_blocked_student",
        "student",
        UUID("2b000000-0000-0000-0000-000000000002"),
        "Plan execution Blocked student",
    ),
    (
        "plan_execution_blocked_parent",
        "parent",
        UUID("2b000000-0000-0000-0000-000000000003"),
        "Plan execution Blocked parent",
    ),
)
