...
- MKE compatibility reviewers: inspect the [M4B design](superpowers/specs/2026-07-13-m4b-mke-readonly-consumer-design.md), [implementation plan](superpowers/plans/2026-07-13-m4b-mke-readonly-consumer.md), and [MKE Evidence boundary ADR](decisions/0005-mke-readonly-evidence-boundary.md). M4B is design-approved but not implemented; the default evaluator and M4A runtime remain MKE-free.
