...
| Governed demo presentation surface | Approved for implementation; presentation-only and release-neutral | [Spec](specs/2026-08-09-governed-demo-presentation-design.md) · [Plan](plans/2026-08-09-governed-demo-presentation.md) |
| Advisor-centered product experience | Implemented locally; not released; presentation-only and release-neutral | [Spec](specs/2026-08-09-advisor-centered-product-experience.md) · [Plan](plans/2026-08-09-advisor-centered-product-experience.md) |
| Reference-driven presentation | Implemented locally; not released; presentation-only and release-neutral | [Spec](specs/2026-08-14-reference-driven-presentation.md) · [Plan](plans/2026-08-14-reference-driven-presentation.md) |
| Native showcase closeout | Implemented locally; presentation evidence and README ordering only; not released | [Plan](plans/2026-08-15-native-showcase-closeout.md) |
