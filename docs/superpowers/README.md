...
| Governed plan execution and reassessment | Approved; implementation has not started | [Spec](specs/2026-07-29-governed-plan-execution-and-reassessment-design.md) |
