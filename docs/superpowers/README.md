...
| Native showcase closeout | Merged in PR #98 on the current default branch; presentation evidence/README ordering only; included in v0.1.6 local synthetic portfolio release; not deployed | [Plan](plans/2026-08-15-native-showcase-closeout.md) |
