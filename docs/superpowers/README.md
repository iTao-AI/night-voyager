...
| Connected same-Case plan execution continuation v1 | Implemented locally; provider-free; not released | [Spec](specs/2026-08-28-connected-same-case-plan-execution-continuation-design.md) · [Plan](plans/2026-08-28-connected-same-case-plan-execution-continuation.md) |
