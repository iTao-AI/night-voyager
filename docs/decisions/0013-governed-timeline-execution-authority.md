...
Accepted and implemented through merged PR #80, PR #83, PR #84, and PR #85. The
complete authority, recovery/reassessment, presentation, and evaluator-first DX
surface is included in released v0.1.5; publication is complete.
...
Historical v0.1.4 ended at migration `0013`; the released v0.1.5 current migration graph
ends at migration `0015`: timeline transition authority remains owned by migration `0014`,
while migration `0015` only closes deterministic demo identity and does not add transition
authority.
